...
class cuda_reverse_iterator:public thrust::reverse_iterator<Iterator>
{	// wrap iterator to run it backwards
	typedef cuda_reverse_iterator<Iterator> _MyType;
	typedef thrust::reverse_iterator<Iterator> _MyBase;
...
__device__ typename cuda_reverse_iterator<Iterator>::difference_type operator-(const cuda_reverse_iterator<Iterator>& left,
	const cuda_reverse_iterator<Iterator>& right) 
{	// return this + integer
	return static_cast<const thrust::reverse_iterator<Iterator>&>(left) - static_cast<const thrust::reverse_iterator<Iterator>&>(right);
}
